...
public class CommentController {
    ...
    @GetMapping(value = "/{board-id}/comments", produces = "application/json")
    ...
    @PostMapping(value ="/{board-id}/comments/create", consumes = "application/json")
    ...
    @PutMapping(value = "/comments/update/{comment-id}", consumes = "application/json")
    ...
    @DeleteMapping(value = "/comments/delete/{comment-id}", consumes = "application/json")
